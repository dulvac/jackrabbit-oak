...
public class AuditEventImplTest {
    ...
    public void ctorStoresFields() {
        ...
        AuditEventImpl e = new AuditEventImpl("security", "t", 42L, payload);
    ...
    public void ctorAcceptsEmptyPayload() {
        AuditEventImpl e = new AuditEventImpl("security", "t", 0L, Map.of());
    ...
    public void payloadInstanceIsImmutable() {
        ...
        AuditEventImpl e = new AuditEventImpl("security", "t", 0L, Map.of("k", "v"));
