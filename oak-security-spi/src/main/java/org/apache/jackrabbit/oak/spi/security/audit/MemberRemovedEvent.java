...
/**
 * Audit event recorded when an authorizable is removed from a group.
 * Recorded at the API call site in
...
public final class MemberRemovedEvent extends SecurityAuditEvent {
     ...
     */
    public static final String TYPE = "user.member.removed";
    ...
    private MemberRemovedEvent(@NotNull String groupPath, @NotNull String memberPath) {
        super(TYPE);
        this.payload = Map.of(
     ...
     * @param memberPath path of the authorizable removed from the
     *                   group, non-null.
     * @return non-null event instance.
     */
    @NotNull
    public static MemberRemovedEvent of(@NotNull String groupPath, @NotNull String memberPath) {
        return new MemberRemovedEvent(groupPath, memberPath);
    }
    ...
    /**
     * @return path of the authorizable removed from the group, non-null.
     */
    @NotNull
