...
public class MemberAddedEventTest {
    ...
    public void factoryCapturesGroupAndMemberPaths() {
        MemberAddedEvent e = MemberAddedEvent.of("/g", "/m");
    ...
    public void typeIsStable() {
        assertEquals("user.member.added", MemberAddedEvent.TYPE);
        MemberAddedEvent e = MemberAddedEvent.of("/g", "/m");
        assertEquals(MemberAddedEvent.TYPE, e.getType());
    }
    ...
    public void payloadHasTwoKeys() {
        ...
        assertEquals("/g", payload.get(MemberAddedEvent.PAYLOAD_GROUP_PATH));
        assertEquals("/m", payload.get(MemberAddedEvent.PAYLOAD_MEMBER_PATH));
    }
}
